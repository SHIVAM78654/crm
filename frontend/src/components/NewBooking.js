...
const AddBooking = ({ onClose }) => {
    ...
    return ( <
        ...
        <
        Grid container spacing = { 3 } > { /* Left Side Inputs */ } <
        Grid item xs = { 12 }
        sm = { 6 } >
        <
        ...
        MenuItem value = "1206" > 302 < /MenuItem> <
        /Select> <
        /FormControl> <
        /Grid>
        ...
        <
        ServiceDropdown formData = { formData }
        ...
        sm = { 6 } >
        <
        TextField fullWidth label = "Received Amount"
        name = "amount"
        type = "text"
        ...
        sm = { 6 } >
        <
        TextField fullWidth label = "Closed By"
        name = "closed"
        ...
        sm = { 6 } >
        <
        TextField fullWidth label = "Payment Date"
        name = "paymentDate"
        type = "date"
        ...
        MenuItem value = "Razorpay" > Yes Bank < /MenuItem> <
        ...
        sm = { 6 } >
        <
        TextField fullWidth label = "After Fund Disbursement"
        ...
        color = "primary"
        type = "submit"
        fullWidth disabled = { loading } // Disable the submit button when loading
        sx = {
            {
